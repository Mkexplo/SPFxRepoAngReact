...
var SpfxAngWebpartWebPart = /** @class */ (function (_super) {
    __extends(SpfxAngWebpartWebPart, _super);
    function SpfxAngWebpartWebPart() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this._isDarkTheme = false;
        _this._environmentMessage = '';
        return _this;
    }
    SpfxAngWebpartWebPart.prototype.render = function () {
        this.domElement.innerHTML = "<ang-element></ang-element>";
    };
    SpfxAngWebpartWebPart.prototype.onInit = function () {
        var _this = this;
        return this._getEnvironmentMessage().then(function (message) {
            _this._environmentMessage = message;
        });
    };
    SpfxAngWebpartWebPart.prototype._getEnvironmentMessage = function () {
        var _this = this;
    ...
    SpfxAngWebpartWebPart.prototype.onThemeChanged = function (currentTheme) {
        if (!currentTheme) {
            return;
        }
    ...
    Object.defineProperty(SpfxAngWebpartWebPart.prototype, "dataVersion", {
        get: function () {
    ...
    SpfxAngWebpartWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
    ...
    return SpfxAngWebpartWebPart;
}(BaseClientSideWebPart));
export default SpfxAngWebpartWebPart;
//# sourceMappingURL=SpfxAngWebpartWebPart.js.map